    ...
    <div>
            ...
            <div style="width:50%;margin:20px auto;height: 200px;">
                <el-row>
                    <el-col :span="12" style="text-align: center;">
                        ...
                        <el-row
                            style="line-height:40px;font-size:12px;color:grey"
                        >真实二手房源，万径承诺真实在售 所见即真</el-row>
                    </el-col>
                    <el-col :span="12" style="text-align: center;">
                        <el-row>
                            <el-image
                                :src="require('../../assets/phphnmv10.png')"
                                style="width:80px;height:80px"
                            ></el-image>
                        </el-row>
                        <el-row style="line-height:40px;font-size:18px;">
        ...
        <el-row class="cefooter">
            ...
            <el-col :span="10">
                <el-row>
                    <span
                        style="color: #fff;font-size: 16px;line-height:100px;"
                    >真实存在，真实在售，真实价格，真实图片！</span>
                </el-row>
    ...
    methods: {
        ...
        business() {
            window.location.href =
                "https://shangye.lianjia.com/bj/xzl/rent/mlist";
        },
        initOldHose() {
